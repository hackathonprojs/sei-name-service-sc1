...
increment_resp=$(printf $password |$seid tx wasm execute $contract '{"reset":{"count":"carol.sei"}}' --from $keyname --broadcast-mode=block  --chain-id atlantic-2 --gas=300000 --fees=30000usei -y --node=https://sei-testnet-rpc.polkachu.com/)
